...
const GenericFormats = {
  formats: {
    'yaml': {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$3.readFileSync(__dirname + '/templates/yaml.hbs', 'utf-8'),
          context
        ),
    },
    'json': {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$3.readFileSync(__dirname + '/templates/json.hbs', 'utf-8'),
          context
        ),
      handlebarsHelpers: {},
    },
    'data-dump': {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$3.readFileSync(__dirname + '/templates/data-dump.hbs', 'utf-8'),
          context
        ),
    },
  },
...
const WebFormats = {
  formats: {
    sass: {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$2.readFileSync(__dirname + '/templates/sass.hbs', 'utf-8'),
          context
        ),
    },
    css: {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$2.readFileSync(__dirname + '/templates/css.hbs', 'utf-8'),
          context
        ),
    },
  },
...
function renderColorSection(context) {
  ...
  context.themes.forEach((theme) => {
    ...
    result += handlebars$1.compile(
      fs$1.readFileSync(__dirname + '/templates/html-colors.hbs', 'utf-8')
    )(handlebarsContext);
  });
  return result;
}
const StyleGuideFormat = {
  formats: {
    ...
    'html': {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$1.readFileSync(__dirname + '/templates/html-file.hbs', 'utf-8'),
