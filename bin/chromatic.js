...
(function (ErrorCode) {
  ...
  ErrorCode[(ErrorCode['ExpectedCloseCurlyBracket'] = 4)] =
  ...
  ErrorCode[(ErrorCode['UnexpectedTokensArray'] = 20)] =
  ...
  ErrorCode[(ErrorCode['InconsistentTokenType'] = 24)] =
    'InconsistentTokenType';
  ErrorCode[(ErrorCode['UnknownFormat'] = 25)] = 'UnknownFormat';
  ErrorCode[(ErrorCode['UnknownValueFormatter'] = 26)] =
...
function throwErrorWithContext(context, code, ...args) {
  ...
  if (process.env.TEST) {
    message =
      '[ERR] ' + ((_a = ErrorCode[code]) !== null && _a !== void 0 ? _a : code);
  } else {
...
const DefaultFormatters = {
  nameFormatters: {
    camelcase: (name, theme) =>
      (name + !theme ? '' : '.' + theme)
        ...
        .replace(/\s+/g, ''),
    kebabcase: (name, theme) =>
      (name + !theme ? '' : '.' + theme)
        .match(/[A-Z]{2,}(?=[A-Z][a-z0-9]*|\b)|[A-Z]?[a-z0-9]*|[A-Z]|[0-9]+/g)
        .filter(Boolean)
        .map((x) => x.toLowerCase())
        .join('-'),
    uppercase: (name, theme) =>
      (name + !theme ? '' : '.' + theme).toUpperCase(),
    lowercase: (name, theme) =>
  ...
  handlebarsHelpers: {
    ...
    'cssValue': (v) => {
      var _a;
      return (_a = v === null || v === void 0 ? void 0 : v.css()) !== null &&
        _a !== void 0
        ? _a
        : '[MISSING VALUE]';
    },
    ...
    'comment': function (s, format = '/* */') {
      ...
      const prefix =
        (_b =
          (_a = format.match(/(\s*)/)) === null || _a === void 0
            ? void 0
            : _a[1]) !== null && _b !== void 0
          ? _b
          : '';
...
class Length extends Value {
  constructor(from, unit) {
    ...
    if (typeof from === 'number') {
      ...
      const nonZeroKeys = Object.keys(from).filter(
...
function asPx(value, unit, baseUnits) {
  ...
  if (unit === 'vmin') {
    base = Math.min(
      (_b =
        baseUnits === null || baseUnits === void 0 ? void 0 : baseUnits.vh) !==
        null && _b !== void 0
        ? _b
        : NaN,
      (_c =
        baseUnits === null || baseUnits === void 0 ? void 0 : baseUnits.vw) !==
        null && _c !== void 0
        ? _c
        : NaN
    );
    ...
    base =
      (_f =
        baseUnits === null || baseUnits === void 0
          ? void 0
          : baseUnits[unit]) !== null && _f !== void 0
        ? _f
        : NaN;
  }
  return base * value;
...
function scaleLength(arg1, arg2) {
  ...
  const result = [-2, -1, 0, 1, 2, 3, 4, 5, 6, 7].map(
    (i) =>
      new Length(roundTo(arg1.value * Math.pow(r, i / n), precision), arg1.unit)
  );
...
let gUseColor =
  ((_a = process.stdout.isTTY) !== null && _a !== void 0 ? _a : false) &&
  !ciInfo.isCI;
const terminal = {
  useColor: (flag) => {
    gUseColor = flag;
...
function scaleColor(arg1, arg2, arg3, arg4) {
  ...
  if ((arg3 === null || arg3 === void 0 ? void 0 : arg3.type()) === 'color') {
    ...
    (arg2 === null || arg2 === void 0 ? void 0 : arg2.type()) === 'color'
  ) {
    c1 = asColor(arg1);
    c2 = asColor(arg2);
    c3 = asColor(arg2);
...
const COLOR_FUNCTIONS = {
  ...
  tint: (c, w) =>
    mixColor(
      whiteColor,
      c,
      w !== null && w !== void 0 ? w : new NumberValue(0.1)
    ),
  shade: (c, w) =>
    mixColor(
      blackColor,
...
function validateArguments(fn, args) {
  ...
  const expectedArguments =
    (_a = FUNCTION_ARGUMENTS[fn]) === null || _a === void 0
      ? void 0
      : _a.split(',').map((x) => x.trim());
  if (expectedArguments) {
    expectedArguments.forEach((x, i) => {
      ...
      if (
        ...
        !types.includes('any') &&
        !types.includes(
          (_a = args[i]) === null || _a === void 0 ? void 0 : _a.type()
        )
      ) {
        throw new SyntaxError(
          ErrorCode.ExpectedArgument,
...
class Stream {
  ...
  error(code, ...args) {
    ...
    const prefix =
      (_b =
        (_a = this.s.slice(0, this.index).match(/^(.*)/)) === null ||
        _a === void 0
          ? void 0
          : _a[1]) !== null && _b !== void 0
        ? _b
    ...
    const suffix =
      (_d =
        (_c = this.s.slice(this.index).match(/(.*)$/)) === null || _c === void 0
          ? void 0
          : _c[1]) !== null && _d !== void 0
        ? _d
        : '';
  ...
  applyOpToLength(op, lhs, rhs) {
    ...
    const multiLength = {};
    [...Object.keys(lhsMulti.value), ...Object.keys(rhsMulti.value)].forEach(
      (unit) => {
          ...
          if (m) {
            ...
            if (typeof resolvedValue !== 'string') {
              if (isArray(resolvedValue)) {
                ...
                const index = Math.round(parseInt(m[2]) / 100);
                alias =
                  (_c = scaleColor(resolvedValue)) === null || _c === void 0
                    ? void 0
                    : _c.get(index);
                ...
                alias =
                  (_d = scaleLength(resolvedValue)) === null || _d === void 0
                    ? void 0
                    : _d.get(index);
              }
...
const WebFormats = {
  formats: {
    sass: {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$1.readFileSync(__dirname + '/templates/sass.hbs', 'utf-8'),
          context
        ),
    },
    css: {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$1.readFileSync(__dirname + '/templates/css.hbs', 'utf-8'),
          context
        ),
    },
  },
  ...
  context.themes.forEach((theme) => {
    ...
    theme.tokens.forEach((token) => {
      ...
      if (isColor(token.tokenValue)) {
        ...
        const similarDeuteranopiaColors =
          (_a = getSimilarColors(color, allColors, 'deuteranopia')) === null ||
          _a === void 0
            ? void 0
            : _a.filter(
                (x) =>
                  !(similarColors === null || similarColors === void 0
                    ? void 0
                    : similarColors.includes(x))
              );
        ...
        [
          ...(similarDeuteranopiaColors !== null &&
          similarDeuteranopiaColors !== void 0
            ? similarDeuteranopiaColors
            : []),
          ...(similarTritanopiaColors !== null &&
          similarTritanopiaColors !== void 0
            ? similarTritanopiaColors
            : []),
          ...(similarProtanopiaColors !== null &&
          similarProtanopiaColors !== void 0
        ...
        handlebarsContext.colors.push({
          ...
          comment:
            (_b = token.tokenDefinition.comment) !== null && _b !== void 0
              ? _b
              : '',
          cls,
          opaqueColor:
            opaqueColor === null || opaqueColor === void 0
              ? void 0
              : opaqueColor.css(),
          similarColors: {
    ...
    result += handlebars.compile(
      fs$2.readFileSync(__dirname + '/templates/html-colors.hbs', 'utf-8')
    )(handlebarsContext);
  });
  return result;
}
const StyleGuideFormat = {
  formats: {
    ...
    'html': {
      ...
      render: (context) =>
        context.renderTemplate(
          fs$2.readFileSync(__dirname + '/templates/html-file.hbs', 'utf-8'),
...
function error(m) {
  ...
  (_a = gConfig.console) === null || _a === void 0
    ? void 0
    : _a.error(terminal.autoFormat(msg));
      ...
      aliasResolver: (identifier) => {
        ...
        if (theme) {
          ...
          if (gTokenDefinitions.has(identifier)) {
            aliasValue = evaluateTokenExpression(
              identifier + '.' + theme,
              (_b =
                (_a = gTokenDefinitions.get(identifier)) === null ||
                _a === void 0
                  ? void 0
                  : _a.value[theme]) !== null && _b !== void 0
                ? _b
                : (_c = gTokenDefinitions.get(qualifiedToken)) === null ||
                  _c === void 0
                ? void 0
                : _c.value['_'],
              theme
        ...
        if (gTokenDefinitions.has(identifier)) {
          if (theme) {
            aliasValue = evaluateTokenExpression(
              identifier + '.' + theme,
              (_d = gTokenDefinitions.get(identifier)) === null || _d === void 0
                ? void 0
                : _d.value[theme],
              theme
            );
          ...
          if (!aliasValue) {
            aliasValue = evaluateTokenExpression(
              identifier,
              (_e = gTokenDefinitions.get(qualifiedToken)) === null ||
                _e === void 0
                ? void 0
                : _e.value['_'],
              theme
        ...
        return aliasValue !== null && aliasValue !== void 0
          ? aliasValue
          : getSuggestion(identifier, gTokenDefinitions);
      },
    });
  ...
  Object.keys(tokens).forEach((token) => {
    ...
    try {
      const normalizedToken = normalizeToken(
        (_a = tokenFile.theme) !== null && _a !== void 0
          ? _a
...
function processPath(f) {
  ...
  if (fs$3.lstatSync(f).isDirectory()) {
    glob.sync(f + '/**/*' + gConfig.tokenFileExt).forEach(processPath);
    return;
  }
  let tokenFile;
  try {
    const content = fs$3.readFileSync(f, 'utf8');
  ...
  if (tokenFile === null || tokenFile === void 0 ? void 0 : tokenFile.groups) {
    Object.keys(tokenFile.groups).forEach((group) => {
      ...
      if (gGroups.has(group)) {
        ...
        info.name =
          (_a = tokenFile.groups[group].name) !== null && _a !== void 0
            ? _a
            : info.name;
        info.comment =
...
function areThemesValid() {
  var _a;
  if (
    ((_a = gConfig.themes) === null || _a === void 0 ? void 0 : _a.length) > 0
  ) {
...
function getFormat(formatName) {
  ...
  Object.keys(result.handlebarsHelpers).forEach((helper) => {
    handlebars$1.registerHelper(helper, result.handlebarsHelpers[helper]);
  });
  return result;
}
function renderFile(format, themes, filepath) {
  ...
  return format.render({
    ...
    renderTemplate: (template, context) =>
      handlebars$1.compile(template.replace(/\r\n/g, '\n'))(context),
  });
}
function render(baseOutputPath, format) {
  ...
  const pathRecord =
    (_a = baseOutputPath && path.parse(baseOutputPath)) !== null &&
    _a !== void 0
      ? _a
      : {
          name: 'tokens',
...
function writeOutputFile(content, outputPath) {
  ...
  if (!fs$3.existsSync(dirname)) {
    fs$3.mkdirsSync(dirname);
  }
  fs$3.writeFileSync(outputPath, content);
...
function build(paths, options) {
  ...
  gWatching =
    (_a =
      options === null || options === void 0 ? void 0 : options.watching) !==
      null && _a !== void 0
      ? _a
      : false;
  gThemes = [];
  ...
  try {
    ...
    gTokenDefinitions.forEach((_def, token) => {
      gThemes.forEach((theme) => {
        ...
        if (theme !== '_') {
          const qualifiedToken = token + '.' + theme;
          if (
            (_a = gTokenValues.get(token)) === null || _a === void 0
              ? void 0
              : _a.equals(gTokenValues.get(qualifiedToken))
          ) {
    ...
    gTokenDefinitions.forEach((def, token) => {
      const types = Object.keys(def.value).reduce((acc, x) => {
        ...
        if (
          !acc.includes(
            (_a = gTokenValues.get(qualifiedToken)) === null || _a === void 0
              ? void 0
              : _a.type()
          )
        )
          acc.push(
            (_b = gTokenValues.get(qualifiedToken)) === null || _b === void 0
              ? void 0
              : _b.type()
          );
        return acc;
    ...
    format.fileHeader =
      (_b = options.header) !== null && _b !== void 0 ? _b : format.fileHeader;
    const outputPath =
      (options === null || options === void 0 ? void 0 : options.output) &&
...
function chromatic(paths, options) {
  ...
  if (
    !((_a =
      configResult === null || configResult === void 0
        ? void 0
        : configResult.isEmpty) !== null && _a !== void 0
      ? _a
      : true)
  ) {
  ...
  if (options === null || options === void 0 ? void 0 : options.config) {
    ...
    if (
      !((_b =
        configResult === null || configResult === void 0
          ? void 0
          : configResult.isEmpty) !== null && _b !== void 0
        ? _b
        : true)
    ) {
      mergeObject(gConfig, configResult.config);
  ...
  gIgnoreErrors =
    (_c =
      options === null || options === void 0
        ? void 0
        : options.ignoreErrors) !== null && _c !== void 0
      ? _c
      : false;
  const messages = [];
  if (
  ...
  gConfig.tokenFileExt =
    (_f =
      (_e =
        options === null || options === void 0
          ? void 0
          : options.tokenFileExt) !== null && _e !== void 0
        ? _e
        : gConfig === null || gConfig === void 0
        ? void 0
        : gConfig.tokenFileExt) !== null && _f !== void 0
      ? _f
      : 'yaml';
  gConfig.verbose =
    (_h =
      (_g =
        ...
        : gConfig === null || gConfig === void 0
        ? void 0
        : gConfig.verbose) !== null && _h !== void 0
      ? _h
      : false;
  ...
  gConfig.outputFormat =
    (_k =
      (_j =
        ...
        : gConfig === null || gConfig === void 0
        ? void 0
        : gConfig.outputFormat) !== null && _k !== void 0
      ? _k
      : '';
    ...
    if (fileExt) {
      const matchingExtensions = Object.keys(gConfig.formats).filter((x) => {
        ...
        return (
          ...
          ((_b =
            gConfig.formats[
              (_a = gConfig.formats[x]) === null || _a === void 0
                ? void 0
                : _a.extends
            ]) === null || _b === void 0
            ? void 0
  ...
  mergeObject(
    gConfig.handlebarsHelpers,
    options === null || options === void 0 ? void 0 : options.handlebarsHelpers
  );
